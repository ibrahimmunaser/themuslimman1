        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-12">
            {WHAT_YOU_GET.map((card) => (
              <div key={card.label} className="flex flex-col gap-3 p-4 sm:p-5 rounded-xl border border-border bg-surface hover:border-gold/25 hover:bg-surface-raised transition-colors">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-gold leading-none mb-1">{card.stat}</p>
