...
type SuccessType = "lifetime" | "subscription" | "free";
...
function PaymentSuccessPageContent() {
  ...
  useEffect(() => {
    ...
    // Subscription payment (Stripe Checkout Session OR Elements-based)
    if (type === "subscription") {
      setSuccessType("subscription");
      // Webhook handles access grant; just show success UI
      setLoading(false);
      return;
    }

    // Lifetime purchase — verify PaymentIntent
    ...
    verifyPayment();
  }, [paymentIntent, sessionId, type, free]);
      ...
      <div className="max-w-lg w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">
            {isSubscription ? "Subscription Active!" : successType === "free" ? "Access Granted!" : "Payment Successful!"}
          </h1>
          <p className="text-lg text-text-secondary">
            {isSubscription
              ? "Welcome to Complete Seerah — monthly access is now active."
