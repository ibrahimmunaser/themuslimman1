...
export async function GET() {
  ...
  return NextResponse.redirect(
    `${APP_URL}/checkout?plan=individual&billing=lifetime&promo=ORTHODOX&utm_source=youtube&utm_medium=influencer&utm_campaign=seerah_launch&utm_content=theorthodoxmuslim`,
    { status: 302 }
  );
}
