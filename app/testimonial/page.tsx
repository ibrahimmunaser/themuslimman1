...
// Note: metadata must be exported from a server component. Because this page is
// a client component (the form needs state), metadata is defined here as a comment
// and should be added to a parent layout or server wrapper if needed. The page
...
export default function TestimonialPage() {
  ...
  if (status === "success") {
    return (
      <>
        <Navbar />
        <main className="min-h-screen bg-ink py-16 flex items-center justify-center">
