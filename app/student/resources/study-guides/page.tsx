...
export const metadata = { title: "Study Guides | Resources" };
...
export default async function StudyGuidesPage() {
  ...
  const progressMap = Object.fromEntries(
    progress.map((p) => {
      ...
      return [p.partNumber, opened.includes("study_guide")];
    })
  );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-text">Study Guides</h1>
            </div>
            <p className="text-text-secondary">
              Detailed study guides to help you review and reinforce key concepts
            </p>
          </div>
