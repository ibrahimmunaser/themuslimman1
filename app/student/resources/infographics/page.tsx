...
import { Image, CheckCircle2, ArrowLeft } from "lucide-react";
import Link from "next/link";

export const metadata = { title: "Infographics | Resources" };
...
export default async function InfographicsPage() {
  ...
  const progressMap = Object.fromEntries(
    progress.map((p) => {
      ...
      return [p.partNumber, opened.includes("infographic")];
    })
  );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-text">Infographics</h1>
            </div>
            <p className="text-text-secondary">
              Visual summaries in three formats: Concise, Standard, and Bento Grid
            </p>
          </div>
