...
export const metadata = { title: "Mindmaps | Resources" };
...
export default async function MindmapsPage() {
  ...
  const progressMap = Object.fromEntries(
    progress.map((p) => {
      ...
      return [p.partNumber, opened.includes("mindmap")];
    })
  );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-text">Mind Maps</h1>
            </div>
            <p className="text-text-secondary">
              Visual mind maps connecting people, places, and events throughout the Seerah
            </p>
          </div>
