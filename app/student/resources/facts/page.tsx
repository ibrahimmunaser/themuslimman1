...
import { BarChart2, CheckCircle2, ArrowLeft } from "lucide-react";
import Link from "next/link";

export const metadata = { title: "Facts | Resources" };
...
export default async function FactsPage() {
  ...
  const progressMap = Object.fromEntries(
    progress.map((p) => {
      ...
      return [p.partNumber, opened.includes("facts")];
    })
  );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-text">Facts</h1>
            </div>
            <p className="text-text-secondary">
              Quick reference fact lists for rapid review and memorization
            </p>
          </div>
