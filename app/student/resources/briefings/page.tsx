...
export const metadata = { title: "Briefings | Resources" };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-text">Briefings</h1>
            </div>
            <p className="text-text-secondary">
              Concise briefing documents for each part covering key topics and themes
            </p>
          </div>
          ...
          <div className="space-y-3">
            {PARTS.map((part) => {
              ...
              const isRead = partProgress?.briefingOpened || false;
