...
export const metadata = { title: "Audio Lessons | Resources" };
...
export default async function AudioPage() {
  ...
  const progressMap = Object.fromEntries(
    progress.map((p) => {
      ...
      return [p.partNumber, opened.includes("audio")];
    })
  );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl font-bold text-text">Listen on the Go</h1>
            </div>
            <p className="text-text-secondary">
              Audio-only versions of every lesson for studying on the go
            </p>
          </div>

          <div className="space-y-3">
            {PARTS.map((part) => {
              const isListened = progressMap[part.partNumber] || false;
