...
export const CREATOR_PROMO_CODES: Record<string, CreatorPromoConfig> = {
  ...
  ANNARBOR29: {
    code: "ANNARBOR29",
    // $79 × 63.291% ≈ $50 discount → $79 − $50 = $29
    discountPercent: 63.291,
    displayLabel: "Ann Arbor Student Lifetime — $29",
    creator: "annarbor",
    utm_source: "direct",
    utm_medium: "promo",
    utm_campaign: "seerah_launch",
  ...
  ANNARBOR59: {
    code: "ANNARBOR59",
    discountPercent: 25.316,
    displayLabel: "Ann Arbor pricing — Individual Lifetime",
    creator: "annarbor",
    utm_source: "direct",
    utm_medium: "promo",
    utm_campaign: "seerah_launch",
  ...
  ANNARBOR119: {
    code: "ANNARBOR119",
    discountPercent: 20.134,
    displayLabel: "Ann Arbor pricing — Family Lifetime",
    creator: "annarbor",
    utm_source: "direct",
    utm_medium: "promo",
    utm_campaign: "seerah_launch",
